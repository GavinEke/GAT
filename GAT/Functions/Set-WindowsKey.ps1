Function Set-WindowsKey {
    ...
    Process {
        ...
        If ($PSBoundParameters.ContainsKey('ComputerName')) {
            $SLSParams.Add('ComputerName', $ComputerName)
        }
        $SoftwareLicensingService = Get-CimInstance @SLSParams
        ...
        If ($KMS) {
            ...
            If ($PSBoundParameters.ContainsKey('ComputerName')) {
                $W32OSParams.Add('ComputerName', $ComputerName)
            }
            $OSversion = Get-CimInstance @W32OSParams | Select-Object -ExpandProperty Caption
        ...
        If ($PSBoundParameters.ContainsKey('ComputerName')) {
            $IPKParams.Add('ComputerName', $ComputerName)
        }
        $SoftwareLicensingService | Invoke-CimMethod @IPKParams


        $RLSParams = @{
            MethodName = 'RefreshLicenseStatus'
        }
        If ($PSBoundParameters.ContainsKey('ComputerName')) {
            $RLSParams.Add('ComputerName', $ComputerName)
        }
        $SoftwareLicensingService | Invoke-CimMethod @RLSParams
    }
